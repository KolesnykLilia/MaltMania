                        ...
                        <div className="product__details">
                            ...
                            <div>
                                ...
                                <span><i class="ri-star-half-s-line"></i></span>     
                                    ...
                                    <p>(<span>{avgRating}</span>рейтинги)</p>
                            </div>

                                <div className="d-flex align-items-center gap-5">
                                    <span className="product__price">${price}</span>
                                    <span>Категорія: {category.toUpperCase()}</span>
                                </div>
                            <p className="mt-3">{shortDesc}</p>

                                <motion.button whileTap={{ scale: 1.2 }}
                                    className="buy__bin" onClick={addToCart}>
                                    Додати в кошик</motion.button>
                        </div>
                    </Col>
                </Row>
            </Container>
            ...
            <section>
                <Container>
                    <Row>
                                        ...
                                        <div className="review__form">
                                            ...
                                            <form action="" onSubmit={submitHandler}>
                                                ...
                                                <div className="form__group">
                                                    ...
                                                    ref={reviewMsg}
                                                    rows={4} type="text"
                                                    placeholder="Напишіть повідомлення...." required />
                                                </div>

                                                <motion.button whileTap={{ scale: 1.2 }} type="submit"
                                                className="buy__bin">Надіслати</motion.button>
                                            </form>
                                        </div>
                                    </div>
                            </div> )} 
                        ...
                        <h2 className="related_title">Вам також може сподобатися</h2>
                        </Col>
